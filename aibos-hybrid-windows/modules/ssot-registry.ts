 ...
 * @returns Promise<any> - The parsed workspace registry
 */
export async function loadCanonicalRegistry(): Promise<any> {
  try {
 ...
 * @returns Promise<any> - The requested section
 */
export async function getRegistrySection(section: string): Promise<any> {
  try {
 ...
 * @returns Promise<any> - Workspace configuration
 */
export async function getWorkspaceConfig(): Promise<any> {
  return await getRegistrySection("workspace");
}

/**
 * Get the file patterns from registry
 * @returns Promise<any> - File patterns configuration
 */
export async function getFilePatterns(): Promise<any> {
  return await getRegistrySection("filePatterns");
}

/**
 * Get the scripts configuration from registry
 * @returns Promise<any> - Scripts configuration
 */
export async function getScriptsConfig(): Promise<any> {
  return await getRegistrySection("scripts");
}

/**
 * Get the modules configuration from registry
 * @returns Promise<any> - Modules configuration
 */
export async function getModulesConfig(): Promise<any> {
 ...
 * @returns Promise<any> - Registry metadata
 */
export async function getRegistryMetadata(): Promise<any> {
  try {
    const registry = await loadCanonicalRegistry();
    return {
